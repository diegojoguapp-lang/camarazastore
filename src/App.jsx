...
const RetailCategoriesAdmin = lazyNamed(() => import('./pages/admin/RetailCategoriesAdmin'), 'RetailCategoriesAdmin')
const RetailBannersAdmin = lazyNamed(() => import('./pages/admin/RetailBannersAdmin'), 'RetailBannersAdmin')
    ...
    <BrowserRouter>
      <Suspense fallback={<RouteFallback />}>
        <Routes>
          ...
          <Route path="/admin/categorias-retail" element={<Admin><RetailCategoriesAdmin /></Admin>} />
          <Route path="/admin/banners-retail" element={<Admin><RetailBannersAdmin /></Admin>} />
