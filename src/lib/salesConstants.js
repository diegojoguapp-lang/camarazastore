...
export function paymentTimingLabel(timing) {
  return PAYMENT_TIMING_LABELS[timing] || timing || '-'
}
...
export function calculateSaleTotals(values) {
  ...
  return {
    ...
    camaraza_net_profit: productSalePrice - productCost - resellerCommission
  }
}
