...
const defaultHelpVideos = [
  { id: 'demo-1', title: 'Cómo funciona Re-venta Camaraza Store', url: 'https://www.youtube.com/', duration: '4 min', thumbnail_url: '/placeholder.svg', is_visible: true, sort_order: 0 },
  { id: 'demo-2', title: 'Cómo publicar productos en estados de WhatsApp', url: 'https://www.youtube.com/', duration: '6 min', thumbnail_url: '/placeholder.svg', is_visible: true, sort_order: 1 },
  { id: 'demo-3', title: 'Cómo vender en Facebook Marketplace', url: 'https://www.youtube.com/', duration: '7 min', thumbnail_url: '/placeholder.svg', is_visible: true, sort_order: 2 }
]
...
export async function saveHelpVideo(payload) {
  ...
  if (!clean.title || !clean.url) throw new Error('T�tulo y URL son obligatorios.')
